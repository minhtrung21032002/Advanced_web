...
<div class="header_wrap">
    ...
    <div class="header_content">
        <a   href="{{ route('sign_up') }}"><span style="margin-left: 10px;">  Sign Up</span></a>
    </div>
...
<!-- ------------------------------ -- -->
        ...
        <div class="member_login">
            ...
            <form action="{{ route ('process.login')}}" method ="POST" id="form">
                @csrf
                <h3 style="font-size: 16.8px; color: #333; font-weight: 300;  margin-bottom: 5px;">Member Login</h3>

                <label for="email" style="font-weight: 300; font-size: 12px;">Email Address:</label> <br>
                <input class="login_input" type="text" name="email" placeholder="Email Address" id="email" required><br>
                <p id="emailError"></p>
